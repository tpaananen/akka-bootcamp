...
namespace WinTail
{
    ...
    public class FileObserver : IDisposable
    {
        ...
        {
            _tailActor.Tell(new TailActor.FileErrorMessage(_fileNameOnly, e.GetException().Message), ActorRefs.NoSender);
        }
        ...
        private void OnFileChanged(object sender, FileSystemEventArgs e)
        {
            if (e.ChangeType == WatcherChangeTypes.Changed)
            {
                ...
                _tailActor.Tell(new TailActor.FileWriteMessage(e.Name), ActorRefs.NoSender);
            }
            else if (e.ChangeType == WatcherChangeTypes.Renamed)
            {
                _tailActor.Tell(new TailActor.FileRenamedMessage(_watcher.Path, e.FullPath, "File renamed to " + e.FullPath), ActorRefs.NoSender);
            }
        }
    }
}
